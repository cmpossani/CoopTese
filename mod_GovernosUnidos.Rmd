...
subtitle: "Janelas temporais estão baseadas nos períodos de governo UNIDOS"
...
est_munic <- calcular_estatisticas(df_TemerBolsonaro_filteredMunic, "Janela Temer-Bolsonaro (Município >= 3)")
...
gerar_mapa_roa(df_TemerBolsonaro, "Temer e Bolsonaro (2017 - 2022)")

```


## **Analisando os outliers da Janela Temer-Bolsonaro (2017 - 2022)**


```{r, echo=FALSE }
# Criando os dois boxplots

resultadosTBMunic <- remover_outliers_zscore(df_TemerBolsonaro_filteredMunic, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreTBMunic <- resultadosTBMunic$df_sem_outliers
df_com_outliers_ZscoreTBMunic <- resultadosTBMunic$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreTBMunic %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreTBMunic, "Janela TB (Z-score Município)")
novo



resultadosTBImed <- remover_outliers_zscore(df_TemerBolsonaro_filteredImed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreTBImed <- resultadosTBImed$df_sem_outliers
df_com_outliers_ZscoreTBImed <- resultadosTBImed$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreTBImed %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreTBImed, "Janela TB (Z-score Reg. Imed.)")
novo


resultadosTBInter <- remover_outliers_zscore(df_TemerBolsonaro_filteredIntermed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreTBInter <- resultadosTBInter$df_sem_outliers
df_com_outliers_ZscoreTBInter <- resultadosTBInter$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreTBInter %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreTBInter, "Janela TB (Z-score Reg. Inter.)")
novo


resultadosTB_UF <- remover_outliers_zscore(df_TemerBolsonaro_filteredUF, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreTB_UF <- resultadosTB_UF$df_sem_outliers
df_com_outliers_ZscoreTB_UF <- resultadosTB_UF$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreTB_UF %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreTB_UF, "Janela TB (Z-score Estadual)")
novo
...
```{r, echo=FALSE}
p1 <- ggplot(df_TemerBolsonaro_filteredMunic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Temer-Bolsonaro \nMunicípio")

p2 <- ggplot(df_sem_outliers_ZscoreTB, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Temer-Bolsonaro - Município \nsem Outliers a 10 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_TemerBolsonaro_filteredImed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Temer-Bolsonaro \nReg. Imediata")

p2 <- ggplot(df_sem_outliers_ZscoreTB, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Temer-Bolsonaro - Reg. Imediata \nsem Outliers a 10 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)

p1 <- ggplot(df_TemerBolsonaro_filteredIntermed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Temer-Bolsonaro \nReg. Intermediária")

p2 <- ggplot(df_sem_outliers_ZscoreTB, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Temer-Bolsonaro - Reg. Intermediária \nsem Outliers a 10 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_TemerBolsonaro_filteredUF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Temer-Bolsonaro \nReg. Intermediária")
...
mod_TemerBolsonaro_Munic <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_munic), data = df_sem_outliers_ZscoreTBMunic)
summary(mod_TemerBolsonaro_Munic)

mod_TemerBolsonaro_UF <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_UF) , data = df_sem_outliers_ZscoreTB_UF)
summary(mod_TemerBolsonaro_UF)

mod_TemerBolsonaro_Inter <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Inter), data = df_sem_outliers_ZscoreTBInter)
summary(mod_TemerBolsonaro_Inter)

mod_TemerBolsonaro_Imed <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Imed), data = df_sem_outliers_ZscoreTBImed)
...
est_munic <- calcular_estatisticas(df_Dilma12_filteredMunic, "Janela Dilma12 (Município >= 3)")
...
# **Início da análise das Regressões da Janela Dilma 1 e 2 ((2012 - 2015) e (2016 - 2017)) **

```{r, echo=FALSE }
# Criando os dois boxplots


resultadosD12Munic <- remover_outliers_zscore(df_Dilma12_filteredMunic, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreD12Munic <- resultadosD12Munic$df_sem_outliers
df_com_outliers_ZscoreD12Munic <- resultadosD12Munic$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreD12Munic %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreD12Munic, "Janela Dilma12 (Z-score Município)")
novo

resultadosD12Imed <- remover_outliers_zscore(df_Dilma12_filteredImed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreD12Imed <- resultadosD12Imed$df_sem_outliers
df_com_outliers_ZscoreD12Imed <- resultadosD12Imed$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreD12Imed %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreD12Imed, "Janela Dilma12 (Z-score Reg. Imediata)")
novo

resultadosD12Inter <- remover_outliers_zscore(df_Dilma12_filteredIntermed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreD12Inter <- resultadosD12Inter$df_sem_outliers
df_com_outliers_ZscoreD12Inter <- resultadosD12Inter$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreD12Inter %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreD12Inter, "Janela Dilma12 (Z-score Reg. Intermediária)")
novo

resultadosD12_UF <- remover_outliers_zscore(df_Dilma12_filteredUF, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreD12_UF <- resultadosD12_UF$df_sem_outliers
df_com_outliers_ZscoreD12_UF <- resultadosD12_UF$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreD12_UF %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreD12_UF, "Janela Dilma12 (Z-score Estadual)")
novo
...
p1 <- ggplot(df_Dilma12_filteredMunic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Dilma12 \nMunicípio")

p2 <- ggplot(df_sem_outliers_ZscoreD12Munic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Dilma12 - Município \nsem Outliers a 3 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_Dilma12_filteredImed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Dilma12 \nReg. Imediata")

p2 <- ggplot(df_sem_outliers_ZscoreD12Imed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Dilma12 - Reg. Imediata \nsem Outliers a 3 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)

p1 <- ggplot(df_Dilma12_filteredIntermed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Dilma12 \nReg. Intermediária")

p2 <- ggplot(df_sem_outliers_ZscoreD12Inter, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Dilma12 - Reg. Intermediária \nsem Outliers a 3 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)

p1 <- ggplot(df_Dilma12_filteredUF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Dilma12 \nEstadual")

p2 <- ggplot(df_sem_outliers_ZscoreD12_UF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Dilma12 - Estado \nsem Outliers a 3 desvios padrão")
...
mod_Dilma12_Munic <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_munic), data = df_sem_outliers_ZscoreD12Munic)
summary(mod_Dilma12_Munic)

mod_Dilma12_UF <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_UF) , data = df_sem_outliers_ZscoreD12_UF)
summary(mod_Dilma12_UF)

mod_Dilma12_Inter <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Inter), data = df_sem_outliers_ZscoreD12Inter)
summary(mod_Dilma12_Inter)

mod_Dilma12_Imed <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Imed), data = df_sem_outliers_ZscoreD12Imed)
...
est_munic <- calcular_estatisticas(df_Lula12_filteredMunic, "Janela Lula12 (Município >= 3)")
...
# **Início da análise das Regressões da Janela Lula 1 e 2 ((2002 - 2005) (2006 - 2010))**
```{r, echo=FALSE, include=TRUE}


#resultadosL12Munic <- remover_outliers_zscore(df_Lula12_filteredMunic, "SOBRAS_POR_ATIVO")
resultadosL12Munic <- remover_outliers_zscore(df_Lula12_filteredMunic, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreL12Munic <- resultadosL12Munic$df_sem_outliers
df_com_outliers_ZscoreL12Munic <- resultadosL12Munic$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreL12Munic %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreL12Munic, "Janela Lula12 (Z-score Município)")
novo

#resultadosL12Imed <- remover_outliers_zscore(df_Lula12_filteredImed, "SOBRAS_POR_ATIVO")
resultadosL12Imed <- remover_outliers_zscore(df_Lula12_filteredImed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreL12Imed <- resultadosL12Imed$df_sem_outliers
df_com_outliers_ZscoreL12Imed <- resultadosL12Imed$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreL12Imed %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreL12Imed, "Janela Lula12 (Z-score Reg. Imediata)")
novo

#resultadosL12Inter <- remover_outliers_zscore(df_Lula12_filteredIntermed, "SOBRAS_POR_ATIVO")
resultadosL12Inter <- remover_outliers_zscore(df_Lula12_filteredIntermed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreL12Inter <- resultadosL12Inter$df_sem_outliers
df_com_outliers_ZscoreL12Inter <- resultadosL12Inter$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreL12Inter %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreL12Inter, "Janela Lula12 (Z-score Reg. Intermediária)")
novo

#resultadosL12_UF <- remover_outliers_zscore(df_Lula12_filteredUF, "SOBRAS_POR_ATIVO")
resultadosL12_UF <- remover_outliers_zscore(df_Lula12_filteredUF, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreL12_UF <- resultadosL12_UF$df_sem_outliers
df_com_outliers_ZscoreL12_UF <- resultadosL12_UF$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreL12_UF %>%
  kable() %>%
  kable_styling(full_width = FALSE)


novo <- calcular_estatisticas(df_sem_outliers_ZscoreL12_UF, "Janela Lula12 (Z-score Estadual)")
novo
...
p1 <- ggplot(df_Lula12_filteredMunic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Lula12 \nMunicípio")

p2 <- ggplot(df_sem_outliers_ZscoreL12Munic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Lula12 - Município \nsem Outliers a 3 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_Lula12_filteredImed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Lula12 \nReg. Imediata")

p2 <- ggplot(df_sem_outliers_ZscoreL12Imed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Lula12 - Reg. Imediata \nsem Outliers a 3 desvios padrão")
# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_Lula12_filteredIntermed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Lula12 \nReg. Intermediária")

p2 <- ggplot(df_sem_outliers_ZscoreL12Inter, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Lula12 - Reg. Intermediária \nsem Outliers a 3 desvios padrão")
# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)

p1 <- ggplot(df_Lula12_filteredUF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela Lula12 \nEstado")

p2 <- ggplot(df_sem_outliers_ZscoreL12_UF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela Lula12 - Estado \nsem Outliers a 3 desvios padrão")
# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)
...
summary_Lula12 <- capture.output(summary(df_Lula12_filteredMunic))
summary_sem_outliersL12 <- capture.output(summary(df_sem_outliers_ZscoreL12Munic))

# HTML para dividir a tela em duas colunas
cat('<div style="display: flex;">')
cat('<div style="flex: 1; padding-right: 10px;">')
cat('<h3>Estatísticas antes de remover outliers (Município)</h3>')
cat('<pre>', paste(summary_Lula12, collapse = "\n"), '</pre>')
cat('</div>')

cat('<div style="flex: 1; padding-left: 10px;">')
cat('<h3>Estatísticas após remover outliers (Município) (Z-score 10 DP)</h3>')
cat('<pre>', paste(summary_sem_outliersL12, collapse = "\n"), '</pre>')
cat('</div>')
cat('</div>')
...
mod_Lula12_Munic <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_munic), data = df_sem_outliers_ZscoreL12Munic)
summary(mod_Lula12_Munic)

mod_Lula12_UF <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_UF) , data = df_sem_outliers_ZscoreL12_UF)
summary(mod_Lula12_UF)

mod_Lula12_Inter <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Inter), data = df_sem_outliers_ZscoreL12Inter)
summary(mod_Lula12_Inter)

mod_Lula12_Imed <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Imed), data = df_sem_outliers_ZscoreL12Imed)
...
est_munic <- calcular_estatisticas(df_FHC12_filteredMunic, "Janela FHC12 (Município >= 3)")
...
```{r df_FHC12, echo=FALSE, include=TRUE}


resultadosFHC12Munic <- remover_outliers_zscore(df_FHC12_filteredMunic, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreFHC12Munic <- resultadosFHC12Munic$df_sem_outliers
df_com_outliers_ZscoreFHC12Munic <- resultadosFHC12Munic$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreFHC12Munic %>%
  kable() %>%
  kable_styling(full_width = FALSE)

novo <- calcular_estatisticas(df_sem_outliers_ZscoreFHC12Munic, "Janela FHC12 (Z-score Município)")
novo


resultadosFHC12Imed<- remover_outliers_zscore(df_FHC12_filteredImed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreFHC12Imed <- resultadosFHC12Imed$df_sem_outliers
df_com_outliers_ZscoreFHC12Imed <- resultadosFHC12Imed$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreFHC12Imed %>%
  kable() %>%
  kable_styling(full_width = FALSE)

novo <- calcular_estatisticas(df_sem_outliers_ZscoreFHC12Imed, "Janela FHC12 (Z-score Reg. Imediata)")
novo


resultadosFHC12Inter<- remover_outliers_zscore(df_FHC12_filteredIntermed, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreFHC12Inter <- resultadosFHC12Inter$df_sem_outliers
df_com_outliers_ZscoreFHC12Inter <- resultadosFHC12Inter$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreFHC12Inter %>%
  kable() %>%
  kable_styling(full_width = FALSE)

novo <- calcular_estatisticas(df_sem_outliers_ZscoreFHC12Inter, "Janela FHC12 (Z-score Reg. Intermediária)")
novo

resultadosFHC12_UF<- remover_outliers_zscore(df_FHC12_filteredUF, "SOBRAS_POR_ATIVO", threshold = 10)
df_sem_outliers_ZscoreFHC12_UF <- resultadosFHC12_UF$df_sem_outliers
df_com_outliers_ZscoreFHC12_UF <- resultadosFHC12_UF$df_com_outliers

# Exibir a tibble formatada com kable
df_com_outliers_ZscoreFHC12_UF %>%
  kable() %>%
  kable_styling(full_width = FALSE)

novo <- calcular_estatisticas(df_sem_outliers_ZscoreFHC12_UF, "Janela FHC12 (Z-score Estadual)")
novo
...
```{r, echo=FALSE}
# Criando os dois boxplots
p1 <- ggplot(df_FHC12_filteredMunic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela FHC12 \nMunicípio")

p2 <- ggplot(df_sem_outliers_ZscoreFHC12Munic, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela FHC12 - Município \nsem Outliers a 10 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_FHC12_filteredImed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela FHC12 \nReg. Imediata")

p2 <- ggplot(df_sem_outliers_ZscoreFHC12Imed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela FHC12 - Reg. Imediata \nsem Outliers a 10 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_FHC12_filteredIntermed, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela FHC12 \nReg. Intermediária")

p2 <- ggplot(df_sem_outliers_ZscoreFHC12Inter, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela FHC12 - Reg. Intermediária \nsem Outliers a 10 desvios padrão")

# Exibindo os gráficos lado a lado
grid.arrange(p1, p2, ncol = 2)


p1 <- ggplot(df_FHC12_filteredUF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Todos as dados da Janela FHC12 \nEstado")

p2 <- ggplot(df_sem_outliers_ZscoreFHC12_UF, aes(y = SOBRAS_POR_ATIVO)) + 
  geom_boxplot() + 
  ggtitle("Janela FHC12 - Estado \nsem Outliers a 10 desvios padrão")
...
```{r FHC2, echo=TRUE}
mod_FHC12_Munic <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_munic), data = df_sem_outliers_ZscoreFHC12Munic)
summary(mod_FHC12_Munic)

mod_FHC12_UF <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_UF) , data = df_sem_outliers_ZscoreFHC12_UF)
summary(mod_FHC12_UF)

mod_FHC12_Inter <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Inter), data = df_sem_outliers_ZscoreFHC12Inter)
summary(mod_FHC12_Inter)

mod_FHC12_Imed <- lmer(SOBRAS_POR_ATIVO ~ Ano + (1 | Unidade_de_Negocio) + (1 | Localizacao_Imed), data = df_sem_outliers_ZscoreFHC12Imed)
